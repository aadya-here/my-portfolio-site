...
const Home: React.FC = () => {
    ...
    return (
        <div className="bg-blue-50 p-0 m-0 text-foreground min-h-screen flex flex-col justify-center items-center relative h-[100vh]">
            <MyAvatar />
            <h3 className="text-2xl font-bold mt-4">hi, i am aadya.</h3>
            <p className='text-xs'>hover on the hair area <br></br>(idk why it only works there)</p>

            <div className="flex justify-center items-center w-full h-auto">
                <div className="absolute w-4/5 h-[90vh]">
            ...
            <div className="flex space-x-4 mt-5 absolute bottom-12">
